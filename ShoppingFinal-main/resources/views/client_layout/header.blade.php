                ...
                <div class="our-link">
                    <ul>
                        @if (Session::has("client"))
                           <li><a href="{{ url('logout') }}"><i class="fa fa-user s_color"></i>
                            Logout</a></li>                          
                        @else
                        <li><a href="{{ url('signin') }}"><i class="fa fa-user s_color"></i>
                            SignIn</a></li> 
                        @endif
            ...
            <li class="cart-box">
                <ul class="cart-list">
                    ...
                    @if (Session::has('topCart'))
                        ...
                        <li>
                            <a href="#" class="photo"><img src="{{asset("storage/product_images/".$prodct["product_image"])}}" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">{{$prodct["product_name"]}} </a></h6>
                            <p>{{$prodct["qty"]}} x - <span class="price">$ {{$prodct["product_price"]}} </span></p>
                        </li>
                        @endforeach
                    @endif           
