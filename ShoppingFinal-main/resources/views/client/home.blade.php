...
@endsection
 ...
 <div id="slides-shop" class="cover-slides">
    <ul class="slides-container">
        @foreach ($sliders as $sldrs)

        <li class="text-center">
            <img src="{{asset("storage/slide_images/".$sldrs->images)}}" alt="">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        {{-- <h1 class="m-b-20"></h1> --}}
                        <p class="m-b-40"> {{$sldrs->description_1}} .</p>
            ...
            <div class="col-lg-3 col-md-6 special-grid best-seller">
                <div class="products-single fix">
                    <div class="box-img-hover">
                        ...
                        <img src="{{asset("storage/product_images/".$prdct->product_image)}}" class="img-fluid" alt="Image">
                        <div class="mask-icon">
                            <ul>
                            ...
                            <a class="cart" href=" {{ url('/addtocart', [$prdct->id]) }} ">Add to Cart</a>
                        </div>
                    </div>
                    <div class="why-text">
                        <h4>{{$prdct->product_name}}</h4>
                        <h5> $ {{$prdct->product_price}} </h5>
                    </div>
                </div>
            </div>
            @endforeach
            ...
            <div class="col-lg-3 col-md-6 special-grid top-featured">
                <div class="products-single fix">
                    <div class="box-img-hover">
                        ...
                        <img src="frontend/frontend/images/img-pro-03.jpg" class="img-fluid" alt="Image">
                        <div class="mask-icon">
                            <ul>
                                <li><a href="#" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
